...
#from ADD.models.feature_align import alignModule
...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalControlnetMixin):
    ...
    def forward(
        ...
        controlnet_cond, feature_map = self.controlnet_cond_embedding(controlnet_cond)
        #if align:
        #    controlnet_cond = self.align(controlnet_cond)
        repre = controlnet_cond
        ...
        if not return_dict:
            return (down_block_res_samples, mid_block_res_sample, repre, feature_map)
