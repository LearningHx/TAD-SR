...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        if only_fea:
            fea_list.extend([new_down_block_res_samples[2],new_down_block_res_samples[5],new_down_block_res_samples[8],new_down_block_res_samples[11]])
            return fea_list
        else:
